...
```typescript
import { initZgsmCodeBase } from "./src/core/zgsm-codebase"
...
```typescript
import { ZgsmCodeBaseSyncService } from "./src/core/zgsm-codebase/client"
