...
```typescript
import { activate as activateZgsm, deactivate as deactivateZgsm } from "./src/core/costrict/base"
...
```typescript
import { getLanguageClass, LangName } from "./src/core/costrict/base"
