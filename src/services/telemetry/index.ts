...
export class TelemetryService {
	...
	public captureCodeAccept(language: string, lines: number) {
		this.logger.debug(`[TelemetryService#captureCodeAccept] language: ${language}, lines: ${lines}`)
		this.captureEvent(TelemetryEventName.CODE_ACCEPT, { language, lines })
	}

	public captureCodeReject(language: string, lines: number) {
		this.logger.debug(`[TelemetryService#captureCodeReject] language: ${language}, lines: ${lines}`)
	...
	public captureCodeTabCompletion(language: string, lines: number, action: string, responceTime: number) {
		this.logger.debug(
			`[TelemetryService#captureCodeTabCompletion] language: ${language}, lines: ${lines}, action: ${action}`,
		)
	...
	public captureError(errorType: string) {
		this.logger.debug(`[TelemetryService#captureError] errorType: ${errorType}`)
