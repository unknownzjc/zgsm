...
- **मौजूदा Issues देखें:** [GitHub Issues](https://github.com/zgsm-ai/costrict/issues) में खोजें।
...
- डॉक्युमेंटेशन के लिए, [Roo Code Docs](https://github.com/zgsm-ai/costrict-Docs) देखें।

### बग या समस्या रिपोर्ट करना

- पहले मौजूदा रिपोर्ट देखें।
- ["Bug Report" टेम्पलेट](https://github.com/zgsm-ai/costrict/issues/new/choose) का उपयोग करके नए बग रिपोर्ट बनाएं।
- **सुरक्षा कमजोरियां:** [security advisories](https://github.com/zgsm-ai/costrict/security/advisories/new) के माध्यम से निजी तौर पर रिपोर्ट करें।
