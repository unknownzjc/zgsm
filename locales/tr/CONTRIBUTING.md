...
- **Mevcut issue'ları kontrol et:** [GitHub Issues](https://github.com/zgsm-ai/costrict/issues)'da ara.
...
- Dokümantasyon için [Roo Code Docs](https://github.com/zgsm-ai/costrict-Docs)'u ziyaret et.

### Hata veya Sorun Bildirme

- Önce mevcut raporları kontrol et.
- ["Bug Report" şablonu](https://github.com/zgsm-ai/costrict/issues/new/choose) kullanarak yeni hata raporları oluştur.
- **Güvenlik açıkları:** [security advisories](https://github.com/zgsm-ai/costrict/security/advisories/new) aracılığıyla özel olarak bildir.
